...
from strongswan_manager.apps.certificates.services import UserCertificateManager, ViciCertificateManager, \
    CertificateManagerException
from strongswan_manager.apps.certificates.container_reader import X509Reader
from strongswan_manager.apps.certificates import models
...
class TestUserCertificateManager(TestCase):
    ...
    def test_add_x509(self):
        ...
        self.assertEqual(count(strongswan_manager.apps.certificates.models.certificates.UserCertificate), 1)
    ...
    def test_add_x509_twice_different_serialnumber(self):
        ...
        self.assertEqual(count(strongswan_manager.apps.certificates.models.certificates.UserCertificate), 2)
    ...
    def test_add_pkcs1_withx509_twice_different_serialnumber(self):
        ...
        self.assertEqual(count(strongswan_manager.apps.certificates.models.certificates.PrivateKey), 1)
        for cert in strongswan_manager.apps.certificates.models.certificates.UserCertificate.objects.all():
    ...
    def test_add_privatekey_without_cert(self):
        ...
        result = self.manager.add_keycontainer(bytes)
        self.assertEqual(len(result.exceptions), 1)
        self.assertEqual(count(strongswan_manager.apps.certificates.models.certificates.PrivateKey), 0)
...
class TestViciCertificateManager(TestCase):
    ...
    def test_add_vici_user_already_exists(self):
        ...
        self.assertEqual(count(strongswan_manager.apps.certificates.models.certificates.ViciCertificate), 1)
        self.assertEqual(count(strongswan_manager.apps.certificates.models.certificates.UserCertificate), 1)
