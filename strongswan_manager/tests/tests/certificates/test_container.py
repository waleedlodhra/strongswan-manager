...
import strongswan_manager.apps.certificates.models.certificates
import strongswan_manager.apps.certificates.models as models
from strongswan_manager.apps.certificates import container_reader
from strongswan_manager.apps.certificates.container_reader import ContainerTypes, ContainerDetector, AbstractContainerReader, \
...
class PCKS1Test(TestCase):
    ...
    def test_to_private_key(self):
        ...
        priv.parse()
        privatekey = strongswan_manager.apps.certificates.models.certificates.PrivateKey.by_reader(priv)
...
class PCKS8Test(TestCase):
    ...
    def test_to_private_key(self):
        ...
        x509 = PrivateReader.by_bytes(bytes)
        x509.parse()
        public = strongswan_manager.apps.certificates.models.certificates.PrivateKey.by_reader(x509)
...
class PCKS12ContainerTest(TestCase):
    ...
    def test_x509(self):
        ...
        containe.parse()
        cert = strongswan_manager.apps.certificates.models.certificates.CertificateFactory.user_certificate_by_x509reader(
            containe.public_key())
        self.assertIsInstance(cert, strongswan_manager.apps.certificates.models.certificates.Certificate)
    ...
    def test_identifier_equal(self):
        ...
        container = PKCS12Reader.by_bytes(bytes)
        container.parse()
        private = strongswan_manager.apps.certificates.models.certificates.PrivateKey.by_reader(container.private_key())
        public = strongswan_manager.apps.certificates.models.certificates.CertificateFactory.user_certificate_by_x509reader(
...
class X509ContainerTest(TestCase):
    ...
    def test_to_public_key(self):
        ...
        x509 = X509Reader.by_bytes(bytes)
        x509.parse()
        public = strongswan_manager.apps.certificates.models.certificates.CertificateFactory.user_certificate_by_x509reader(x509)
        self.assertIsNotNone(public)
