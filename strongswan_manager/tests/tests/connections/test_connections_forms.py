...
from strongswan_manager.apps.connections.forms.ConnectionForms import ChooseTypeForm, Ike2CertificateForm, Ike2EapForm, \
    Ike2EapCertificateForm
from strongswan_manager.apps.connections.forms.SubForms import CaCertificateForm, ServerIdentityForm, HeaderForm, \
    UserCertificateForm
from strongswan_manager.apps.connections.models import IKEv2Certificate, Child, Proposal, Address, EapAuthentication, \
