...
from strongswan_manager.apps.certificates.models import Certificate
...
from strongswan_manager.apps.server_connections.forms.ConnectionForms import ChooseTypeForm, Ike2CertificateForm, Ike2EapForm, \
    Ike2EapCertificateForm
from strongswan_manager.apps.server_connections.forms.SubForms import RemoteCertificateForm, RemoteIdentityForm, HeaderForm, \
    ServerCertificateForm
from strongswan_manager.apps.server_connections.models import IKEv2Certificate, Child, Proposal, Address, EapAuthentication, \
