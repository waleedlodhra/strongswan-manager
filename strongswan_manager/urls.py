...
handler400 = 'strongswan_manager.apps.views.bad_request'
handler403 = 'strongswan_manager.apps.views.permission_denied'
handler404 = 'strongswan_manager.apps.views.page_not_found'
handler500 = 'strongswan_manager.apps.views.server_error'
